...
var DisplayAttackPokemon = React.createClass({
  fMoveSelect(e){
      ...
      <div className={active + " display-pokemon"}>
        ...
        <div className="row">
          ...
          <div className="main-adjusted col-xs-2">
            <div className="adjusted-label">Atk.</div>
            <div className="adjusted-value">{Math.round(this.props.pokemon.adjustedAttack)}</div>
          </div>
        </div>
        <div className="row">
          {types}
